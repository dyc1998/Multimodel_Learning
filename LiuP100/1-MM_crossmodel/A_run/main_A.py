...
parser.add_argument('--learning_rate', type=int, default=0.01, help='')# 0.05
...
def main(opts, flod):
    ...
    for epoch in range(start_epoch, opts.epochs):
        train_loss, train_acc, train_pre, train_recall, train_f1 = train_one_epoch_A(model, device, train_loader,
                                                                                     loss_f, optimizer, epoch)
        eval_loss, eval_acc, eval_pre, eval_recall, eval_f1 = eval_one_epoch_A(model, eval_loader, device, loss_f,
                                                                               epoch)
        ...
        tb_writer.add_scalar('eval_lr', optimizer.param_groups[0]['lr'], epoch)
