...
duanwen
2022-9-13
重新写一下这个AST模型，虽然之前写过，但是还是没有搞懂，看了看zhouli的手写代码，感觉逻辑性很强，所以可以学习一手，把这个模型的架构搞得熟悉一点
'''
import torch
...
class ASTModel(nn.Module):
    ...
    def __init__(self, label_dim=527, fstride=10, tstride=10,
                 input_fdim=128, input_tdim=1024, imagenet_pretrain=True,
                 audioset_pretrain=False, model_size='base224', verbose=True):
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            if os.path.exists('/home/liuzhengyu/duanw/python_code/30-AST_316/pretriain_model/audioset_10_10_0.4593.pth') == False:
                # this model performs 0.4593 mAP on the audioset eval set
                audioset_mdl_url = 'https://www.dropbox.com/s/cv4knew8mvbrnvq/audioset_0.4593.pth?dl=1'
                wget.download(audioset_mdl_url, out='../pretrained_models/audioset_10_10_0.4593.pth')
            sd = torch.load('/home/liuzhengyu/duanw/python_code/30-AST_316/pretriain_model/audioset_10_10_0.4593.pth', map_location=device)
    ...
    def forward(self, x):
        ...
        x = x.unsqueeze(1)    #将[B,H,W]-->[B,1,H,W]其实你需要用2dcnn，那你就必须要三个维度。
        x = x.transpose(2, 3)
